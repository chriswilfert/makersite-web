  ...
  wp_enqueue_script('mediaelement');
    ...
    function qode_startit_scripts() {
        ...
        if(qode_startit_options()->getOptionValue('google_maps_api_key') != '') {
            $google_maps_api_key = "AIzaSyBfeqJVjuuQ1fx32w86S3pOkKqDoP-INvE";
...
{
    wp_enqueue_style('theme-override', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
}
